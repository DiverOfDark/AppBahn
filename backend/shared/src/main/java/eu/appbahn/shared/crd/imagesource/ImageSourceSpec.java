 ...
 * {@link #imageSource} is meaningful. All sub-blocks are nullable — the operator validates
 * "exactly one matches" and surfaces a {@code ConfigInvalid} condition if the spec is malformed.
 */
@Data
...
public class ImageSourceSpec {
    ...
    private ImageSourcePromotionSpec imageSource;
