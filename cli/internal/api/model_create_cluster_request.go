...
func NewCreateClusterRequest(name string, kubeconfigSecret string) *CreateClusterRequest {
...
func (o *CreateClusterRequest) GetKubeconfigSecret() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CreateClusterRequest) GetKubeconfigSecretOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CreateClusterRequest) SetKubeconfigSecret(v string) {
