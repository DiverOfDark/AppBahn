...
func (o *UpdateClusterRequest) GetDescriptionOk() (*string, bool) {
	if o == nil || IsNil(o.Description) {
		return nil, false
	}
...
func (o *UpdateClusterRequest) HasDescription() bool {
	if o != nil && !IsNil(o.Description) {
		return true
	}
...
func (o *UpdateClusterRequest) SetDescription(v string) {
	o.Description = &v
}
