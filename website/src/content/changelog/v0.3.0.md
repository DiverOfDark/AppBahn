...
AppBahn's domain model, materialised. Every object has a slug (`name-abcdefg`), a URL
that matches the console path, and a tier in the hierarchy that determines where
RBAC and quota decisions are made.
...
- Resource slots prepared (implementation lands in v0.5.0).
