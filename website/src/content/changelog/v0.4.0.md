...
The platform-as-a-product layer. Before this release, AppBahn had no opinion on how
an organisation would actually be modelled inside it. After this release, it does.
...
Self-hosted platforms that hand-wave authorisation do not survive contact with real
organisations. The roles here are intentionally boring; the point is that your
existing IdP drives them, and the quota enforcement is real rather than advisory.
